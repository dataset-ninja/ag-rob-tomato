...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = "/home/alex/DATASETS/TODO/AgRobTomato/Dataset-Greenhouse_Tomato_AgRob"
    ...
    obj_class_unriped = sly.ObjClass("unriped", sly.Rectangle, color=(128, 0, 0))
    obj_class_breaking = sly.ObjClass("breaking", sly.Rectangle, color=(0, 128, 0))
    obj_class_reddish = sly.ObjClass("reddish", sly.Rectangle, color=(128, 128, 0))
    obj_class_riped = sly.ObjClass("riped", sly.Rectangle, color=(0, 0, 128))

    project = api.project.create(workspace_id, project_name, change_name_if_conflict=True)
    meta = sly.ProjectMeta(
        obj_classes=[obj_class_unriped, obj_class_breaking, obj_class_reddish, obj_class_riped]
    )
